package com.mvillasono.customer_service;
...
import com.mvillasono.customer_service.dto.MovieDto;
...
class CustomerServiceApplicationTests {
	...
	public void health() {
		...
		Assertions.assertTrue(responseEntity.getStatusCode().is2xxSuccessful(), "Health check failed");
	}
	...
	public void updateGenre() {
		...
		var requestEntity = new RequestEntity<>(genreUpdateRequest, HttpMethod.PATCH,
				URI.create("/api/customers/1/genre"));
